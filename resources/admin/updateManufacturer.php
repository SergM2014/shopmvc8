<section class="create__block">
    ...
    <form action="/adminManufacturers/update" method="post">
        ...
        <p>
            <input type="text" name="manufacturer_title" id="manufacturer_title" value="<?=  @isset($_POST['manufacturer_title']) ? @$title : $manufacturer->title  ?>" >
        </p>
        ...
        <p>
            <input type="text" name="manufacturer_url" id="manufacturer_url" value="<?=  @isset($_POST['manufacturer_url']) ? @$url : $manufacturer->url  ?>" >
        </p>
