...
<form id="delete-product-item" action="/<?= \Lib\HelperService::currentLang() ?>admin<?= ucfirst($significant == 'category' ? 'categorie' : $significant) ?>s/delete" method="post" class="modal-confirm-btn-container">
