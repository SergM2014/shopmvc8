...
<form class="content-zone__form" method="POST" action="/contacts/addMessage" id="content-zone__form">
    <p class="content-zone__form-element">
        ...
        <input type="text" name="name"  class="content-zone__form-element-field" required>
    ...
    <p class="content-zone__form-element">
        ...
        <input type="tel" name="phone"  class="content-zone__form-element-field"  pattern="\d{3}-\d{3}-\d{2}-\d{2}" required>
    ...
    <p class="content-zone__form-element">
        ...
        <input type="email" name="email"  class="content-zone__form-element-field" >
    ...
    <textarea name="message" id="message" class="content-zone__form-element-message" cols="45" rows="15" required></textarea>
    ...
    <div class="content-zone__form-element">
        ...
        <small class=""><?= @$error['captcha'] ?></small>
    </div>
